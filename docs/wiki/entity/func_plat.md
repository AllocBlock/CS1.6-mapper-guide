...
这个实体的工作模式比较特殊，这里特别说明一下。这个电梯和你想象的可能不同，这个实体当你站上去后它会上升，带你到高处，然后你下电梯后，他马上会自己跑到最下面，等另一个人上电梯，这个过程是全自动的，你是不能用引发来控制它上升下降的。如果不给他取名字，电梯最开始就在下面等着载人；取了名字的话，最开始它在最上面，要按了按钮它才开始工作，跑到最下面等人。
